...
class SemanticSegmentationApp:
    ...
    def run(self):
        ...
        # Create sidebar
        api_url = ui_components.create_sidebar()
    ...
    def handle_image_selection(self):
        ...
        if selected_image_id:
            ...
            ui_components.display_info("Please select an image from the dataset or upload your own image.")
    ...
    def process_dataset_image(self, image_id: str):
        ...
        ground_truth = data_service.load_image(data_service.get_ground_truth_path(image_id))
        
        if original_image:
            # Process prediction
            predicted_mask, metadata = self.get_prediction(data_service.get_image_path(image_id))
    ...
    def get_prediction(self, image_path: str) -> Tuple[Optional[Image.Image], Optional[dict]]:
